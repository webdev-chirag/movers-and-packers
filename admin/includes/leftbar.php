...
<li><a href="#"><i class="fa fa-files-o"></i> Vehicle Types</a>
<ul>
<li><a href="create-brand.php">Create Vehicle Types</a></li>
<li><a href="manage-brands.php">Manage Vehicle Types</a></li>
</ul>
</li>

<li><a href="#"><i class="fa fa-car"></i> Services</a>
					<ul>
						<li><a href="post-avehical.php">Post a Services</a></li>
						<li><a href="manage-vehicles.php">Manage Services</a></li>
					</ul>
				</li>
