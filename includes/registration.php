            ...
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();">
                <div class="form-group">
                  <input type="text" id="name"   class="form-control" name="fullname" placeholder="Username" required="required" pattern="^[a-zA-Z0-9]+([._]?[a-zA-Z0-9]+)*$">
                </div>
                      <div class="form-group">
                  <input type="tel" class="form-control" name="mobileno" placeholder="Mobile Number" maxlength="10" required="required">
                </div>
                <div class="form-group">
