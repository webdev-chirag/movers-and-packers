...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Confirmed</a><br>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Not Confirm yet</a>
            <div class="clearfix"></div>
              ...
              { 
                ...
                $bookid=htmlentities($result->BookingNumber);
                $sql2="SELECT * FROM tblbooking WHERE BookingNumber=$bookid";
...
<hr />
              <?php }}  else { ?>
                <h5 align="center" style="color:red">No book
                ing yet</h5>
              <?php } ?>
