...
<title>Movers & Packers|| Contact Us</title>
<!--Bootstrap -->
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            <div class="form-group">
              ...
              <input type="text" name="fullname" class="form-control white_bg" id="fullname" pattern="^[a-zA-Z]{4,}(?: [a-zA-Z]+)?(?: [a-zA-Z]+)?$" title="Fullname should not contain '123' or '@'" required>
            </div>
            <div class="form-group">
